...
Having latency throttling built into devtools would make it much easier to test and optimise web applications for users on high-latency connections, without leaving the browser.
